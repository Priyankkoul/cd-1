...
%%
    ...
    Assignment  : ID opassgn E1 	{
		...
		| list
		| string
		| ID PLUS PLUS { yyerrok; yyclearin;printf("****Incorrect Use of + Symbol! Parsing Continued! ****\n");}
		| ID MINUS MINUS { yyerrok; yyclearin;printf("****Incorrect Use of - Symbol! Parsing Continued! ****\n");}		
		; 
